	...
	<body>	
		...
		<div class="main">
			<div class="container">
				...
				<p>	Para temas relacionados exclusivamente con el servicio de comercio electrónico:</p>
				<h4>	999999999</h4>
				<h4> clientes@finddle.es</h4><span>
				
				<p> A su disposición los 365 días del año.</p>
				<p>Servicio técnico de atención al cliente de Finddle.</p><span>
			</div>
		</div>
